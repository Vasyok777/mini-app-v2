...
class StartSessionResponse$Type extends MessageType<StartSessionResponse> {
    constructor() {
        super("trading.StartSessionResponse", [
            ...
            { no: 2, name: "initial_price", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ }
        ]);
    }
...
class GetCurrentPriceRequest$Type extends MessageType<GetCurrentPriceRequest> {
    ...
    create(value?: PartialMessage<GetCurrentPriceRequest>): GetCurrentPriceRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.sessionId = "";
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCurrentPriceRequest): GetCurrentPriceRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetCurrentPriceRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string session_id = 1; */
        if (message.sessionId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.sessionId);
        let u = options.writeUnknownFields;
...
class GetCurrentPriceResponse$Type extends MessageType<GetCurrentPriceResponse> {
    ...
    create(value?: PartialMessage<GetCurrentPriceResponse>): GetCurrentPriceResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.price = 0;
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetCurrentPriceResponse): GetCurrentPriceResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetCurrentPriceResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* double price = 1; */
        if (message.price !== 0)
...
class PlaceBetRequest$Type extends MessageType<PlaceBetRequest> {
    constructor() {
        super("trading.PlaceBetRequest", [
            ...
            { no: 3, name: "direction", kind: "enum", T: () => ["trading.BetDirection", BetDirection] }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PlaceBetRequest): PlaceBetRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: PlaceBetRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string session_id = 1; */
        if (message.sessionId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.sessionId);
        /* int64 user_id = 2; */
...
class PlaceBetResponse$Type extends MessageType<PlaceBetResponse> {
    constructor() {
        super("trading.PlaceBetResponse", [
            ...
            { no: 2, name: "entry_price", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PlaceBetResponse): PlaceBetResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: PlaceBetResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string bet_id = 1; */
        if (message.betId !== "")
...
class GetBetResultRequest$Type extends MessageType<GetBetResultRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBetResultRequest): GetBetResultRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBetResultRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string bet_id = 1; */
        if (message.betId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.betId);
        let u = options.writeUnknownFields;
...
class GetBetResultResponse$Type extends MessageType<GetBetResultResponse> {
    constructor() {
        super("trading.GetBetResultResponse", [
            ...
            { no: 4, name: "closing_price", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetBetResultResponse): GetBetResultResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetBetResultResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool win = 1; */
        if (message.win !== false)
            writer.tag(1, WireType.Varint).bool(message.win);
        /* int32 points = 2; */
        if (message.points !== 0)
...
class GetPriceHistoryRequest$Type extends MessageType<GetPriceHistoryRequest> {
    ...
    create(value?: PartialMessage<GetPriceHistoryRequest>): GetPriceHistoryRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPriceHistoryRequest): GetPriceHistoryRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetPriceHistoryRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 start_time = 1; */
...
class GetPriceHistoryResponse$Type extends MessageType<GetPriceHistoryResponse> {
    constructor() {
        super("trading.GetPriceHistoryResponse", [
            { no: 1, name: "price_points", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => PricePoint }
        ]);
    }
    create(value?: PartialMessage<GetPriceHistoryResponse>): GetPriceHistoryResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.pricePoints = [];
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPriceHistoryResponse): GetPriceHistoryResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated trading.PricePoint price_points */ 1:
                    message.pricePoints.push(PricePoint.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetPriceHistoryResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated trading.PricePoint price_points = 1; */
        for (let i = 0; i < message.pricePoints.length; i++)
            PricePoint.internalBinaryWrite(message.pricePoints[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class PricePoint$Type extends MessageType<PricePoint> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PricePoint): PricePoint {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: PricePoint, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* double price = 1; */
        if (message.price !== 0)
            writer.tag(1, WireType.Bit64).double(message.price);
        /* int64 timestamp = 2; */
...
class StreamPriceRequest$Type extends MessageType<StreamPriceRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StreamPriceRequest): StreamPriceRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: StreamPriceRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string session_id = 1; */
        if (message.sessionId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.sessionId);
        let u = options.writeUnknownFields;
 ...
 */
export const TradingGameService = new ServiceType("trading.TradingGameService", [
    { name: "StartSession", options: {}, I: StartSessionRequest, O: StartSessionResponse },
    { name: "GetCurrentPrice", options: {}, I: GetCurrentPriceRequest, O: GetCurrentPriceResponse },
    { name: "PlaceBet", options: {}, I: PlaceBetRequest, O: PlaceBetResponse },
    { name: "GetBetResult", options: {}, I: GetBetResultRequest, O: GetBetResultResponse },
    { name: "GetPriceHistory", options: {}, I: GetPriceHistoryRequest, O: GetPriceHistoryResponse },
    { name: "StreamPrice", serverStreaming: true, options: {}, I: StreamPriceRequest, O: PriceUpdate }
]);
