...
class User$Type extends MessageType<User> {
    constructor() {
        super("user.User", [
            ...
            { no: 4, name: "points", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class UpdateUserNicknameRequest$Type extends MessageType<UpdateUserNicknameRequest> {
    constructor() {
        super("user.UpdateUserNicknameRequest", [
            { no: 1, name: "telegram_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "new_nickname", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<UpdateUserNicknameRequest>): UpdateUserNicknameRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.telegramId = 0n;
        message.newNickname = "";
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdateUserNicknameRequest): UpdateUserNicknameRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UpdateUserNicknameRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
...
class Task$Type extends MessageType<Task> {
    constructor() {
        super("user.Task", [
            ...
            { no: 5, name: "reward_points", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 6, name: "progress", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 7, name: "goal", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
...
class GetUserTasksRequest$Type extends MessageType<GetUserTasksRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetUserTasksRequest): GetUserTasksRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetUserTasksRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        let u = options.writeUnknownFields;
...
class GetUserTasksResponse$Type extends MessageType<GetUserTasksResponse> {
    constructor() {
        super("user.GetUserTasksResponse", [
            ...
            { no: 2, name: "tasks", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Task },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetUserTasksResponse): GetUserTasksResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetUserTasksResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* repeated user.Task tasks = 2; */
        for (let i = 0; i < message.tasks.length; i++)
            Task.internalBinaryWrite(message.tasks[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
...
class CompleteTaskRequest$Type extends MessageType<CompleteTaskRequest> {
    constructor() {
        super("user.CompleteTaskRequest", [
            { no: 1, name: "telegram_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "task_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class CompleteTaskResponse$Type extends MessageType<CompleteTaskResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CompleteTaskResponse): CompleteTaskResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CompleteTaskResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
...
class CreateUserRequest$Type extends MessageType<CreateUserRequest> {
    constructor() {
        super("user.CreateUserRequest", [
            { no: 1, name: "telegram_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "referrer_id", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "nickname", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class GetUserReferralsRequest$Type extends MessageType<GetUserReferralsRequest> {
    ...
    create(value?: PartialMessage<GetUserReferralsRequest>): GetUserReferralsRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.telegramId = 0n;
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetUserReferralsRequest): GetUserReferralsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetUserReferralsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        let u = options.writeUnknownFields;
...
class UserReferralsResponse$Type extends MessageType<UserReferralsResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UserReferralsResponse): UserReferralsResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* optional user.UserReferrals data */ 2:
                    message.data = UserReferrals.internalBinaryRead(reader, reader.uint32(), options, message.data);
                    break;
                case /* optional string message */ 3:
                    message.message = reader.string();
                    break;
    ...
    internalBinaryWrite(message: UserReferralsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* optional user.UserReferrals data = 2; */
        if (message.data)
            UserReferrals.internalBinaryWrite(message.data, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* optional string message = 3; */
        if (message.message !== undefined)
            writer.tag(3, WireType.LengthDelimited).string(message.message);
        let u = options.writeUnknownFields;
...
class UserReferrals$Type extends MessageType<UserReferrals> {
    constructor() {
        super("user.UserReferrals", [
            { no: 1, name: "referrals", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UserReferrals): UserReferrals {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UserReferrals, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class UpdateUserPointsRequest$Type extends MessageType<UpdateUserPointsRequest> {
    constructor() {
        super("user.UpdateUserPointsRequest", [
            { no: 1, name: "telegram_id", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "points", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<UpdateUserPointsRequest>): UpdateUserPointsRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.telegramId = 0n;
        message.points = 0n;
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdateUserPointsRequest): UpdateUserPointsRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UpdateUserPointsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        /* int64 points = 2; */
...
class CheckAndUpdateTasksRequest$Type extends MessageType<CheckAndUpdateTasksRequest> {
    ...
    create(value?: PartialMessage<CheckAndUpdateTasksRequest>): CheckAndUpdateTasksRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.telegramId = 0n;
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckAndUpdateTasksRequest): CheckAndUpdateTasksRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckAndUpdateTasksRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        let u = options.writeUnknownFields;
...
class CheckAndUpdateTasksResponse$Type extends MessageType<CheckAndUpdateTasksResponse> {
    ...
    create(value?: PartialMessage<CheckAndUpdateTasksResponse>): CheckAndUpdateTasksResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.success = false;
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckAndUpdateTasksResponse): CheckAndUpdateTasksResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckAndUpdateTasksResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* optional string message = 2; */
 ...
 */
export const CheckAndUpdateTasksResponse = new CheckAndUpdateTasksResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UserAvatar$Type extends MessageType<UserAvatar> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UserAvatar): UserAvatar {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UserAvatar, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        /* string avatar_url = 2; */
...
class SetUserAvatarRequest$Type extends MessageType<SetUserAvatarRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SetUserAvatarRequest): SetUserAvatarRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SetUserAvatarRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        /* string avatar_url = 2; */
...
class SetUserAvatarResponse$Type extends MessageType<SetUserAvatarResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SetUserAvatarResponse): SetUserAvatarResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SetUserAvatarResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* optional string message = 2; */
...
class GetUserAvatarRequest$Type extends MessageType<GetUserAvatarRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetUserAvatarRequest): GetUserAvatarRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetUserAvatarRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        let u = options.writeUnknownFields;
...
class GetUserAvatarResponse$Type extends MessageType<GetUserAvatarResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetUserAvatarResponse): GetUserAvatarResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* optional user.UserAvatar avatar */ 2:
                    message.avatar = UserAvatar.internalBinaryRead(reader, reader.uint32(), options, message.avatar);
                    break;
                case /* optional string message */ 3:
                    message.message = reader.string();
                    break;
    ...
    internalBinaryWrite(message: GetUserAvatarResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* optional user.UserAvatar avatar = 2; */
        if (message.avatar)
            UserAvatar.internalBinaryWrite(message.avatar, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* optional string message = 3; */
        if (message.message !== undefined)
            writer.tag(3, WireType.LengthDelimited).string(message.message);
        let u = options.writeUnknownFields;
...
class DeleteUserAvatarRequest$Type extends MessageType<DeleteUserAvatarRequest> {
    ...
    create(value?: PartialMessage<DeleteUserAvatarRequest>): DeleteUserAvatarRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.telegramId = 0n;
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeleteUserAvatarRequest): DeleteUserAvatarRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DeleteUserAvatarRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 telegram_id = 1; */
        if (message.telegramId !== 0n)
            writer.tag(1, WireType.Varint).int64(message.telegramId);
        let u = options.writeUnknownFields;
...
class DeleteUserAvatarResponse$Type extends MessageType<DeleteUserAvatarResponse> {
    ...
    create(value?: PartialMessage<DeleteUserAvatarResponse>): DeleteUserAvatarResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.success = false;
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeleteUserAvatarResponse): DeleteUserAvatarResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: DeleteUserAvatarResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool success = 1; */
        if (message.success !== false)
            writer.tag(1, WireType.Varint).bool(message.success);
        /* optional string message = 2; */
...
export const UserService = new ServiceType("user.UserService", [
    ...
    { name: "GetUserReferrals", options: {}, I: GetUserReferralsRequest, O: UserReferralsResponse },
    { name: "UpdateUserPoints", options: {}, I: UpdateUserPointsRequest, O: UserResponse },
    { name: "GetUserTasks", options: {}, I: GetUserTasksRequest, O: GetUserTasksResponse },
    { name: "CompleteTask", options: {}, I: CompleteTaskRequest, O: CompleteTaskResponse },
    { name: "CheckAndUpdateTasks", options: {}, I: CheckAndUpdateTasksRequest, O: CheckAndUpdateTasksResponse },
    { name: "SetUserAvatar", options: {}, I: SetUserAvatarRequest, O: SetUserAvatarResponse },
    { name: "GetUserAvatar", options: {}, I: GetUserAvatarRequest, O: GetUserAvatarResponse },
    { name: "DeleteUserAvatar", options: {}, I: DeleteUserAvatarRequest, O: DeleteUserAvatarResponse },
    { name: "UpdateUserNickname", options: {}, I: UpdateUserNicknameRequest, O: UserResponse }
]);
